...
RcppExport SEXP _sumgp_symm_distance_matrix(SEXP m1SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _sumgp_distance_matrix(SEXP m1SEXP, SEXP m2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type m1(m1SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_sumgp_symm_distance_matrix", (DL_FUNC) &_sumgp_symm_distance_matrix, 1},
    {"_sumgp_distance_matrix", (DL_FUNC) &_sumgp_distance_matrix, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_sumgp(DllInfo *dll) {
